...
import moe.gensoukyo.automata.actions.audio.PlayMusicAction;
import moe.gensoukyo.automata.actions.audio.PlaySoundAction;
import moe.gensoukyo.automata.actions.audio.StopMusicAction;
...
import moe.gensoukyo.automata.actions.scene.SceneColorAction;
import moe.gensoukyo.automata.actions.scene.SceneColorClearAction;
import moe.gensoukyo.automata.actions.scene.SceneTextAction;
import moe.gensoukyo.automata.actions.scene.SceneTextClearAction;
import moe.gensoukyo.automata.actions.text.TextColorAction;
import moe.gensoukyo.automata.actions.text.TextPosAction;
import moe.gensoukyo.automata.actions.text.TextSpeedAction;
    ...
    public static Action createActionFromParameters(EventType eventType, int timeKey, java.util.List<ParameterValue> values) {
        return switch (eventType) {
            ...
            case SCENE_COLOR -> new SceneColorAction(timeKey,
                    ...
                    values.get(1).intValue.intValue());
            ...
            case TEXT_POS -> new TextPosAction(timeKey,
                    values.get(1).floatValue.get(),
                    values.get(2).floatValue.get());
            case TEXT_COLOR -> new TextColorAction(timeKey, values.get(0).colorValue.clone());
